  ...
  columns: [
    ...
    },
    {
      ...
      positions: [
        ...
        { id: "C4P6", label: "Save User Defaults", commandKey: "shape_save_defaults", defaultValue: 1, values: [{ label: "SAVE", value: 1 }] },
        { id: "C4P7", label: "Reset User Defaults", commandKey: "shape_reset_defaults", defaultValue: 1, values: [{ label: "RESET", value: 1 }] },
